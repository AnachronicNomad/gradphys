...
tdata <- SharedData$new(rosterdata, group = 'linegrphs');
      ...
      htmltools::browsable(
        tagList(
          tags$div(
            ...
            tags$ul(
              ...
              tags$li(
                ...
                tags$button(
                  ...
                  `data-bs-toggle` = 'pill',
                  `data-bs-target` = '#linegrph_physicsphd',
                  type = 'button',
                  role = 'tab',
                  `aria-controls` = 'linegrph_physicsphd',
                  `aria-selected` = 'true',
                  "PhDs"
                )
              )
            ...
            tags$div(
              id = 'linegrph_tabs-content',
              tags$div(
                class = 'tab-pane show active',
                id = 'linegrph_physicsphd',
                role = 'tabpanel',
                `aria-labelledby` = 'linegrph_physicsphd-tab',
                ggplotly(
                  width = 0.9*1280,
                  height = 0.9*720,
                  tooltip = c('Year', 'Physics_PhDs', 'Institution'),
                  p = ggplot(
                        tdata, 
                        aes(
                           x = Year, 
