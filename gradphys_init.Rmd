...
For example, in the 2015 report, data regarding enrollments are the finalized numbers of the 2014-2015 academic year; plus all conferred Bachelors, MS, and PhD certificates from January through December (inclusive) of the 2015 calendar year.
...
`Institution`-level data were adjusted for varying spellings/canonization over time (e.g. `Appl Phy` -\> `Appl Phys`), and (`TODO :>`) `Coll -> U` if the institution re-designated in a later year .
